...
```{r barplot,fig.align='center',out.width="40%"}
x <- table(mtcars$cyl)
...
```{r ggplot2,fig.align='center',out.width="50%"}
...
```{r lattice,fig.align='center',out.width="50%"}
...
```{python,results='hide',collapse=TRUE,fig.allign='center'}
